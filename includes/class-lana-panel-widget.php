...
class Lana_Panel_Widget extends WP_Widget{
	...
	public function form( $instance ) {
		...
		$instance['panel_title']  = strip_tags( $instance['panel_title'] );
		$instance['panel_body']   = wpautop( $instance['panel_body'] );
		...
		<?php else : ?>
            <textarea class="widefat" rows="5" id="<?php echo $this->get_field_id( 'panel_body' ); ?>"
                      name="<?php echo $this->get_field_name( 'panel_body' ); ?>"><?php echo $instance['panel_body']; ?></textarea>
		<?php endif; ?>
		...
		<?php else : ?>
            <textarea class="widefat" rows="5" id="<?php echo $this->get_field_id( 'panel_footer' ); ?>"
                      name="<?php echo $this->get_field_name( 'panel_footer' ); ?>"><?php echo $instance['panel_footer']; ?></textarea>
		<?php endif; ?>
